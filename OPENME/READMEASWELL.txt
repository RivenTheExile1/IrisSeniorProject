...
and they would not spin continiously. I thought that the motor or PCM board were broken. So I de-soldered de-soldered one of the motors and 
...
but are hard as hell to put back on so......... zipties. Thats particularly it when it comes to what hardware modifactions I made.
...
hello_drone in dronekit's documentaiton  https://dronekit-python.readthedocs.io/en/latest/. ( This is just the genaric link to the library ). 
